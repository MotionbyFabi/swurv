...
const About = () => {
    return (
        ...
        <div class="header">
            ...
            <div class="wrapper">
                <div id="left" class="box center" style="background-image: url('../../assets/quote-image-1.png');">
            ...
            <div class="wrapper">
                <div id="left" class="box center" style="background-image: url('../../assets/quote-image-2.png');" >
            ...
            <div class="wrapper">
                <div id="left" class="box center" style="background-image: url('../../assets/quote-image-3.png');" >
